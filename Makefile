...
vic:
	clear && cl65 ./*.c -O3 -t vic20 -o palante20_MVB0B1B2B3B5.prg -C vic20-32k.cfg || exit 1
	rm ./*.o && xvic ./palante20_MVB0B1B2B3B5.prg
c64:
	clear && cl65 ./*.c -O3 -t c64 -o palante64_M6.prg || exit 1
...
cbm2:
	clear && cl65 ./*.c -O3 -t cbm610 -o palante-cbm2.prg || exit 1
